...
<body>
<sf:form modelAttribute="staff" method="post" action="${pageContext.request.contextPath}/admin/staff/edit"> 
<input type="hidden" name="id" value="${staff.id }">
<div style="background-color:#353C44" width="100%" style="padding-top:10px"><span class="STYLE1">修改员工</span></div>
<table>
<tr>
	...
	<tr>
		<td>用户名</td>
		<td><sf:input path="username" disabled="true"/></td>
		
	</tr>
	<tr>
		<td>密码</td>
		<td><input name="password" type="password" value=""><sf:errors path="password"/></td>
	</tr>
	<tr>
		<td>权限</td>
