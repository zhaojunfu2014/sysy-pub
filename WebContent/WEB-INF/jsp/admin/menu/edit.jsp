...
<body>
<sf:form modelAttribute="menu" method="post" action="${pageContext.request.contextPath}/admin/menu/edit"> 
<input type="hidden" name="id" value="${menu.id }">
<div style="background-color:#353C44" width="100%" style="padding-top:10px"><span class="STYLE1">修改菜单</span></div>
<table>
<tr>
	...
	<tr>
		<td>等级</td>
		<td><input name="level" type="text" value="${menu.level}"></td>
	</tr>
	<tr>
		<td>显示在首页</td>
		<td>
